...
/**
 * Helper class to get link travel times from events file.*/
public final class TrafficAnalysis {

	private TrafficAnalysis(){}

	/**
	 * Creates a TravelTimeCalculater, runs an anlysis of the event file and return the link travel times.
	 * */
