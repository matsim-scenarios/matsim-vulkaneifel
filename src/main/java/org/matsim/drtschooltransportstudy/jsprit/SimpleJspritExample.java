...
/**
 * Runs a jspirit example with three shipments.
 * */
public final class SimpleJspritExample {

	private SimpleJspritExample(){}
	...
	public static void main(String[] args) {
		...
		VehicleImpl vehicle1 = VehicleImpl.Builder.newInstance("drt-vehicle-1")
				.setType(vehicleType)
				// This vehicle goes to end location at the end of the service
				.setStartLocation(Location.newInstance(0, 0)).setEndLocation(Location.newInstance(10, 10))
				.build();

		VehicleImpl vehicle2 = VehicleImpl.Builder.newInstance("drt-vehicle-2")
				.setType(vehicleType)
				//This vehicle does not need to go to specific place at the end
