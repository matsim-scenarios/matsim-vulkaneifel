...
public class RunJsprit implements MATSimAppCommand {
	...
	private void runJsprit(String matsimConfig, boolean infiniteFleet, boolean printProgressStatistics) {
		...
		new FleetReader(fleetSpecification).parse(scenario.getConfig().getContext());
