package org.matsim.drtschooltransportstudy;

import java.io.IOException;

import org.matsim.analysis.ZonalAvailabilityModule;
import org.matsim.drtschooltransportstudy.matchingalgorithm.SimpleUnitCapacityRequestInserterModule;
...
import org.matsim.utils.PredeterminedLinkSelectionModule;
import org.matsim.utils.RebalanceStudyUtils;

/**
 * Runs a deprecated version of the VulkaneifelScenario with drt and rebalancing strategies.
 * */
public final class RunDrtSchoolTransportStudy {
	private static final Logger log = LogManager.getLogger(RunDrtSchoolTransportStudy.class);
	...
	private static final int REBALANCE_INTERVAL = 120;
...
//	private static final String[] REBLANCE_STRATEGIES = { "PlusOne", "NoRebalance", "Adaptive" };
	...
	private RunDrtSchoolTransportStudy(){}
