...
/**
* Event handler to get the availabilty rate of drt vehicles.
 * */
public final class ZonalAvailabilityHandler implements ActivityStartEventHandler, ActivityEndEventHandler,
	...
	// value in range [0, 1]
	private static final double FACTOR_OF_NEIGHTBOURING_ZONES = 0.5;
	// 01:00 - 25:00 (24 hours)
	private final Map<DrtZone, MutableDouble> allDayAvailableTimeCount = new HashMap<>();
	// 06:00 - 09:00 (3 hours)
	private final Map<DrtZone, MutableDouble> peakHourAvailableTimeCount = new HashMap<>();
