...
public class MergeTransitSchedules implements MATSimAppCommand {
	...
	/**
	 * Takes the first vehicles in the list and applies the mergeVehicles function below on the vehicles collection.
	 */
	...
	/**
	 * Takes the first schedule in the list and applies the mergeTransitSchedule function below on the schedule collection.
	 */
